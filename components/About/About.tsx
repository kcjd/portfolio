      ...
      <div className="flex flex-col md:flex md:flex-row-reverse justify-between gap-12 mb-16">
        ...
        <div className="max-w-3xl">
          <div className="flex flex-col gap-4 mb-12 text-lg leading-normal">
            <p>Hello ! ✌️</p>
            <p>
              Après un parcours enrichissant dans le design, durant lequel j’ai
              pu (re)découvrir l’univers du développement, j’ai décidé de suivre
              une formation chez OpenClassrooms, que j’ai validée avec succès !
            </p>
            <p>
              Spécialisé en développement JavaScript / React, j’aime apporter
              des solutions simples et efficaces, et créer de bonnes expériences
              utilisateur. Je recherche un poste de développeur front-end junior
              en CDI, à Lyon ou en remote.
            </p>
